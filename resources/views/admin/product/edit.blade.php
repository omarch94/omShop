            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control"  value="{{$products->small_description}}" name="small_description">
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control"  value="{{$products->meta_keywords}}"name="meta_keywords">
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    @if ($products->image)
                        <img src="{{ asset('assets/uploads/products/'.$products->image)}}" width="250px">
